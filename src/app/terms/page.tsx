      ...
      <div className="min-h-screen bg-background text-foreground">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold">Data and Security</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold">Updates and Termination</h2>
              <p className="text-gray-300">
                The Service Provider may wish to update the application at some point. You agree to always accept updates 
                to the application when offered to you. The Service Provider may also wish to cease providing the application 
                and may terminate its use at any time without providing termination notice to you.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-300">
                ...
                <a href="mailto:uttkarsh.dav@gmail.com" className="text-primary hover:underline">
                  uttkarsh.dav@gmail.com
                </a>
              </p>
            </section>
          </div>
