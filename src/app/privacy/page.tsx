      ...
      <div className="min-h-screen bg-background text-foreground">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold">Opt-Out Rights</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-300">
                If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at uttkarsh.dav@gmail.com.
              </p>
            </section>
